...
class class_obj:
    def __init__(self, theta):
        ...
        self.Omega_m, self.As = theta
        
    def class_computation(self):
        m1, m2, m3 = get_masses(2.5e-3, 7.37e-5, 0.1, 'NH')
        omega_nu = Mnu2omeganu(0.1, self.Omega_m)
        commonsettings  = {
              'N_ur':0.00641,
              'N_ncdm':3,
              'output':'mPk',
...
def log_prior(theta):
    ...
    if 0.18 <= Omega_m <= 0.42 and 1.29e-9 < As < 2.91e-9:
        return 0.0
    return -np.inf
...
def log_likelihood(theta, data, cov):
    ...
    B = np.array([[ 296660.29539493,  110644.83465026,  220229.21818887,
          82912.36815535, -136026.37220686,  584619.82596714,
        -378783.92132293,  115321.13718779,  291499.2784304 ,
         430343.23213884, -184305.68610628, -152899.83782443,
         406909.14760333,  115077.55694578,  -11412.18515463,
         101940.9491814 ,  268694.76820534,  214377.03912566,
         138324.39385216,  -79969.55025574],
       [ -94623.45239379,    2776.75401313, -121755.47306431,
        -341544.14525168, -137833.6211707 , -172685.01009686,
         195107.61856695, -484903.47661534,  355981.17868552,
        -391790.40483957,  -21793.0300752 ,  133340.2793181 ,
         -31780.83094229,  -40853.79349316,  668633.79685967,
        -356952.37768137,  650030.11353481,  214121.03383019,
         681110.74566952, 1329808.13153475]])
...
filename = "MCMC_%swalkers_z%s_LSST_binave_2params_compressed.h5"%(nwalkers, z_source)
